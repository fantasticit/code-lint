...
exports.init = function () { return __awaiter(void 0, void 0, void 0, function () {
    var pkgPath, start, spinner, toAddFiles, toRemoveFiles, toInstallDeps, toRemoveDeps, toModifyPkg, collect, useYarn, removeCommand, installCommand, toRemoveDepsWithoutVersion, toInstallDepsWithoutVersion, e_1, pkg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                toAddFiles = [];
                toRemoveFiles = [];
                toInstallDeps = ['@fantasticit/code-lint'];
                toRemoveDeps = [];
                toModifyPkg = [];
                collect = function (fn) {
            ...
            case 1:
                ...
                _a.label = 2;
            case 2:
                removeCommand = useYarn
                    ? function (deps) { return "yarn remove " + deps + " -D"; }
                    : function (deps) { return "npm uninstall " + deps + " --save-dev"; };
                installCommand = useYarn
                    ? function (deps) { return "yarn add " + deps + " -D"; }
                    : function (deps) { return "npm install " + deps + " --save-dev"; };
