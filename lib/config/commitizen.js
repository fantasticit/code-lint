...
var getDefaultCZConfig = function () {
    return {
        types: [
            {
                value: 'feat',
            ...
            {
                value: 'refactor',
                name: 'refactor: A code change that neither fixes a bug nor adds a feature（即不是新增功能，也不是修改bug的代码变动）',
            },
            {
                value: 'build',
            ...
            {
                value: 'ci',
                name: 'ci: Changes to our CI configuration files and scripts (example scopes: Circle, BrowserStack, SauceLabs)',
            },
            {
                value: 'docs',
...
exports.default = getDefaultCZConfig;
